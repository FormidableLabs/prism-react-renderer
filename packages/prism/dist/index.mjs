...
var Highlight = class extends Component {
  constructor() {
    ...
    this.tokenize = (Prism2, code, grammar, language) => {
      const env = {
        code,
        grammar,
        language,
      ...
      const tokens = env.tokens = Prism2.tokenize(env.code, env.grammar);
      Prism2.hooks.run("after-tokenize", env);
      return tokens;
    };
  }
  render() {
    const { Prism: Prism2, language, code, children } = this.props;
    const themeDict = this.getThemeDict(this.props);
    const grammar = Prism2.languages[language];
    const mixedTokens = grammar !== void 0 ? this.tokenize(Prism2, code, grammar, language) : [code];
...
export {
  ...
  defaultProps_default as defaultProps
};
